/**
 * Talent — Settings page (shared by company & freelancer).
 */
import { useLanguage } from "@/contexts/LanguageContext";
import { PageHeader } from "@/core/components";
import { Card, CardContent } from "@/components/ui/card";
import { Bell, Shield, User, Building2, Users } from "lucide-react";
...
export default function TalentSettings() {
  ...
  const sections = [
    ...(isCompany ? [
      { icon: Building2, title_en: "Company Profile", title_ar: "ملف الشركة", desc_en: "Update company information and branding", desc_ar: "تحديث بيانات الشركة والعلامة التجارية", link: "/enterprise/portal/company-profile" },
      { icon: Users, title_en: "Team Members", title_ar: "أعضاء الفريق", desc_en: "Manage who has access to this workspace", desc_ar: "إدارة من لديه صلاحية الوصول لمساحة العمل", link: "/talent/portal/company/team" },
    ] : []),
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description_en="Manage your Talent workspace preferences"
        description_ar="إدارة تفضيلات مساحة العمل"
      />
