/**
 * Consulting Portal Layout — role-aware sidebar + role-first quick bar.
 */
...
export default function ConsultingLayout({ children }: { children: ReactNode }) {
  ...
  const groups = isExpert ? expertGroups : clientGroups;
  const headerConfig = isExpert ? CONSULTING_EXPERT_HEADER : CONSULTING_CLIENT_HEADER;
