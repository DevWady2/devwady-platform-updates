          ...
          <TooltipProvider>
            ...
            <BrowserRouter>
              ...
              <Routes>
                ...
                <Route path="/instructor/jobs" element={<Layout><AuthGuard><RoleGuard allowedAccountTypes={['instructor', 'admin']} allowedRoles={['instructor', 'admin']}><InstructorJobs /></RoleGuard></AuthGuard></Layout>} />
                <Route path="/instructor/courses" element={<Layout><AuthGuard><RoleGuard allowedAccountTypes={['instructor', 'admin']} allowedRoles={['instructor', 'admin']}><InstructorCoursesPage /></RoleGuard></AuthGuard></Layout>} />
                <Route path="/instructor/courses/:slug" element={<Layout><AuthGuard><RoleGuard allowedAccountTypes={['instructor', 'admin']} allowedRoles={['instructor', 'admin']}><InstructorCourseDetail /></RoleGuard></AuthGuard></Layout>} />
                <Route path="/instructor/questions" element={<Layout><AuthGuard><RoleGuard allowedAccountTypes={['instructor', 'admin']} allowedRoles={['instructor', 'admin']}><InstructorQuestions /></RoleGuard></AuthGuard></Layout>} />
                <Route path="/instructor/assistants" element={<Layout><AuthGuard><RoleGuard allowedAccountTypes={['instructor', 'admin']} allowedRoles={['instructor', 'admin']}><InstructorAssistants /></RoleGuard></AuthGuard></Layout>} />
