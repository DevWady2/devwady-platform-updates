...
export default function InstructorStudents() {
  ...
  if (!user || (role !== "instructor" && role !== "admin")) return <Navigate to="/" replace />;
  if (!isSampleCourse && resolvedCourse && resolvedCourse.instructor_id !== user.id && role !== "admin") return <Navigate to="/instructor/workspace/courses" replace />;
