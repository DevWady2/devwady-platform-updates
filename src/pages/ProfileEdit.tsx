...
export default function ProfileEdit() {
  ...
  const getAccountHome = () => {
    if (accountType === "admin") return "/admin";
    if (accountType === "company") return "/company/jobs";
    return "/profile";
  };
      ...
      <div className="container mx-auto px-4 max-w-3xl space-y-6">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.03 }}
          ...
          <div>
            ...
            <FieldHint show={isOnboarding && !form.avatar_url} pts={accountType === "company" ? 10 : 15} lang={lang} />
          </div>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.06 }}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className={isOnboarding && !form.full_name ? "border-s-2 border-s-warning ps-3" : ""}>
              ...
              <FieldHint show={isOnboarding && !form.full_name} pts={accountType === "company" ? 10 : 15} lang={lang} />
            </div>
            ...
            <div className={`sm:col-span-2 ${isOnboarding && !form.location ? "border-s-2 border-s-warning ps-3" : ""}`}>
              ...
              <FieldHint show={isOnboarding && !form.location} pts={accountType === "company" ? 5 : 10} lang={lang} />
            </div>
          </div>
          <div className={isOnboarding && !form.bio ? "border-s-2 border-s-warning ps-3" : ""}>
            ...
            />
            <FieldHint show={isOnboarding && !form.bio} pts={accountType === "company" ? 5 : 10} lang={lang} />
          </div>
        </motion.div>
        ...
        {/* ── Company (if company account type) ── */}
        {accountType === "company" && (
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.18 }}
          ...
          {isOnboarding ? (
            <Link to={getAccountHome()} className="block text-center text-sm text-muted-foreground hover:text-foreground transition-colors">
