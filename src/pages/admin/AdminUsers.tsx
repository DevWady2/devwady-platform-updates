...
const resolveUserAccountType = (user: Pick<UserRecord, "account_type">) => normalizeAccountType(user.account_type);
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <ExportCSVButton data={filtered.map(u => ({ email: u.email, full_name: u.full_name, account_type: resolveUserAccountType(u), account_status: u.account_status, approval_status: u.approval_status, capabilities: u.capabilities?.join(", "), created_at: u.created_at, last_sign_in_at: u.last_sign_in_at }))} filename="users" />
