/**
 * Canonical account identity regression coverage for shared surfaces.
 */
...
describe("canonical account identity shared surfaces", () => {
  ...
  it("keeps consulting dashboard behavior stable with a canonical freelancer account", async () => {
