/**
 * Regression coverage for the canonical account identity boundary.
 */
...
describe("canonical account identity regressions", () => {
  ...
  it("AddRoleDialog stays informational and disabled", async () => {
    ...
    await waitFor(() => expect(screen.getByText(/single account type/i)).toBeInTheDocument());
  });
});
