...
import { normalizeAccountType, type AccountType } from "@/core/types";
...
type CompletenessTarget = AccountType;
...
export function useProfileCompleteness(forAccountType?: CompletenessTarget): ProfileCompleteness {
  ...
  const targetAccountType = normalizeAccountType(forAccountType) ?? accountType;
